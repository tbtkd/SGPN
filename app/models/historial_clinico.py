...
class HistorialClinico(db.Model):
    ...
    detalle_alergias = db.Column(db.Text)
    detalle_intolerancias = db.Column(db.Text)
    detalle_otro_descontrol_metabolico = db.Column(db.Text)
    ...
    def actualizar(paciente_id, datos):
        try:
            ...
            historial.detalle_alergias = datos.get('detalle_alergias')
            historial.detalle_intolerancias = datos.get('detalle_intolerancias')
            historial.detalle_otro_descontrol_metabolico = datos.get('detalle_otro_descontrol_metabolico')
